...
namespace MoviePlatform.Migrations
{
    ...
    [Migration("20220618222347_InitialMigrate")]
            ...
            modelBuilder.Entity("MoviePlatform.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdDirector = 3,
                            IdWriter = 3,
                            ImageUrl = "C:\\Images\\drStrange.jpg",
                            Title = "Titanic"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MoviePlatform.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdReview = 1,
                            CreationDate = new DateTime(2022, 6, 18, 22, 23, 46, 722, DateTimeKind.Utc).AddTicks(3504),
                            Grade = 5,
                            IdMovie = 2,
                            IdUser = 1,
                        ...
                        {
                            IdReview = 2,
                            CreationDate = new DateTime(2022, 6, 18, 22, 23, 46, 722, DateTimeKind.Utc).AddTicks(3506),
                            Grade = 3,
                            IdMovie = 2,
                            IdUser = 2,
                            Text = "A bit boring."
                        ...
                        {
                            IdReview = 3,
                            CreationDate = new DateTime(2022, 6, 18, 22, 23, 46, 722, DateTimeKind.Utc).AddTicks(3507),
                            Grade = 5,
                            IdMovie = 2,
                            IdUser = 3,
                            Text = "Impressive."
                        ...
                        {
                            IdReview = 4,
                            CreationDate = new DateTime(2022, 6, 18, 22, 23, 46, 722, DateTimeKind.Utc).AddTicks(3508),
                            Grade = 4,
                            IdMovie = 2,
                            IdUser = 4,
                            Text = "Nice graphics."
